...
export default function Quiz() {
  ...
  function handleNext() {
    ...
    if (idx + 1 >= total) {
      ...
      ls[level] = Math.max(ls[level] || 0, finalScore)
    ...
    return (
      <div style={{ maxWidth: 600, margin: '0 auto', padding: '10px 0' }}>
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 10, justifyContent: 'center', flexWrap: 'wrap' }}>
            ...
            <button onClick={() => {
              ...
              setResults([]); setFinished(false); setScore(0)
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
          {questions.map((qu, i) => (
            <div key={i} style={{
              background: 'var(--card)', border: `1px solid ${results[i]?.correct ? 'rgba(74,222,128,.25)' : 'rgba(251,113,133,.25)'}`,
          ...
          return (
            ...
            >
              <div style={{
                ...
                background: selected === null ? 'var(--bg3)' : (i === q.correct ? 'rgba(74,222,128,.2)' : i === selected ? 'rgba(251,113,133,.2)' : 'var(--bg3)'),
